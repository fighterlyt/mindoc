...
cd $GOPATH/src/github.com/fighterlyt/mindoc/
...
/go/src/github.com/fighterlyt/mindoc/mindoc_linux_amd64 install

/go/src/github.com/fighterlyt/mindoc/mindoc_linux_amd64
